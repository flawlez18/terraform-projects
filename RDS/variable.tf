...
#   default = ["admin", "dev_PRE_DB_USER", "dev_PRO_DB_USER", "dev_DEXCHANGE_DB_USER","dev_AUTH_DB_USER","dev_IDN_DB_USER","dev_SSTORAGE_DB_USER","dev_UDDD_DB_USER","dev_QBO_DB_USER","dev_FILE_DB_USER" "dev_ROYALTY_DB_USER"]
# }

# variable "proxy_password" {
#   default = ["admin", "dev_PRE_DB_PWD", "dev_PRO_DB_PWD", "dev_DEXCHANGE_DB_PWD","dev_AUTH_DB_PWD","dev_IDN_DB_PWD","dev_SSTORAGE_DB_PWD","dev_UDDD_DB_PWD","dev_QBO_DB_PWD","dev_FILE_DB_PWD" "dev_ROYALTY_DB_PWD"]
# }
